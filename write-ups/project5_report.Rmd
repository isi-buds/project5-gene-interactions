...
<<<<<<< HEAD
There is a high probability of a given cell
...
>>>>>>> fd755d7eb1ec18bc6e169fd459a5a06571fc3704

![](../analysis/eda/first-set-heatmaps/sample/motif-06-#01-index-3584.png)
Most of the mass is at 0,0 for this replicate.

The following is a histogram of the probabilites across all columns.
...
There are an unusually high count of 1.0, but this likely do to truncating the count values.
